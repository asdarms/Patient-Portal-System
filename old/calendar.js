// From https://github.com/nggepe/calendar-gc/blob/master/src/calendar-gc.js
...
var gcObject = {
    ...
    render() {
      const elem = $(this.el);
      elem.html("");
      const gcCalendar = $(`<cust class="gc-calendar"></cust>`);
      elem.append(gcCalendar);
      const head = $(`<cust class="gc-calendar-header"></cust>`);
        ...
        e.forEach(function (e) {
          ...
          gcObject.options.events.forEach(function (evt) {
            if (
              ...
              cell.addClass("event");
              var event = $(`<cust class="gc-event ${evt.className}">${evt.eventName}</cust>`);
